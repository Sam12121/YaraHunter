...
Mount the root directory into the YaraHunter container at a location of your choosing (e.g. `/toae/mnt`) and specify the running container ID:
...
# highlight-next-line
    ...
    toaeio/toae_malware_scanner_ce:2.0.0 \
# highlight-next-line
    --host-mount-path /toae/mnt --container-id 69221b948a73
```
...
Refer to the detailed [documentation for CI/CD integration](https://github.com/Sam12121/YaraHunter/tree/main/ci-cd-integration).
