...
func ParseOptions() (*Options, error) {
	options := &Options{
		RulesPath:            flag.String("rules-path", "/home/toae/usr", "All .yar and .yara files in the given directory will be compiled"),
		...
		RulesListingURL:      flag.String("rules-listing-url", "https://threat-intel.deepfence.io/yara-rules/listing.json", "Toae threat intel yara rules listing (Default: threat-intel.deepfence.io/yara-rules/listing.json)"),
